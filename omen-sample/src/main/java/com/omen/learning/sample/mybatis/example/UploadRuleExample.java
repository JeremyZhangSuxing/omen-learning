...
public class UploadRuleExample {
    ...
    public UploadRuleExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public UploadRuleExample orderBy(String ... orderByClauses) {
    ...
    public static Criteria newAndCreateCriteria() {
        UploadRuleExample example = new UploadRuleExample();
        return example.createCriteria();
    }

    public UploadRuleExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public UploadRuleExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private UploadRuleExample example;

        protected Criteria(UploadRuleExample example) {
            super();
            this.example = example;
        }

        public UploadRuleExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.omen.learning.sample.mybatis.example.UploadRuleExample example);
    }
}