...
public class UploadRecordExample {
    ...
    public UploadRecordExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public UploadRecordExample orderBy(String ... orderByClauses) {
    ...
    public UploadRecordExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public UploadRecordExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private UploadRecordExample example;

        protected Criteria(UploadRecordExample example) {
            super();
            this.example = example;
        }

        public UploadRecordExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.omen.learning.sample.mybatis.example.UploadRecordExample example);
    }
}